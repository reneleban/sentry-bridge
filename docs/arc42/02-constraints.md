...
| TC-07 | Obico protocol: Moonraker agent identity (`moonraker_obico` v2.1.0) | Moonraker identity enables `http.tunnelv2` for the Obico file browser tab; OctoPrint identity does not support the tunnel protocol (ADR-002) |
