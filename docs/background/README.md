...
> **SPEC-04 (`docs/requirements/04-interfaces.md`) is the authoritative interface specification.**
...
- **[docs/requirements/04-interfaces.md](../requirements/04-interfaces.md)** — PrusaLink API, Obico WebSocket Protocol, SentryBridge REST API
- **[docs/requirements/api.yaml](../requirements/api.yaml)** — OpenAPI 3.0 spec for the SentryBridge REST API
